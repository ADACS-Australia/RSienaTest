...
{
	# if this turns out to be satisfactory, corresponding code portions can be deleted.
	effects <- RSienaTest::allEffects[RSienaTest::allEffects$effectGroup == effectGroup, ]
	if (nrow(effects) == 0)
	{
