...
BasicPrimarySetting::BasicPrimarySetting() :
		GeneralSetting(),
		lpNetwork(0),
		// rDistTwoLayer(),
		// lpiter(0),
...
void BasicPrimarySetting::initSetting(Network* const lpNetwork) {
...
void BasicPrimarySetting::terminateSetting(Network* const lpNetwork) {
...
void BasicPrimarySetting::initSetting() {
	// if (lpiter == 0) {
...
void BasicPrimarySetting::terminateSetting() {
...
ITieIterator* BasicPrimarySetting::getSteps() {
...
int BasicPrimarySetting::getSize() {
	return this->pPrimaryNetwork()->outDegree(ego());
}

const Network * BasicPrimarySetting::pPrimaryNetwork() const {
